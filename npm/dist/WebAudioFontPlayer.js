...
'use strict'
console.log('WebAudioFont Reverberator/Compressor v1.16 GPL3');
function WebAudioFontReverberator(audioContext) {
	...
	this.echoDry = audioContext.createGain();
	...
	this.echoDry.gain.setTargetAtTime(0.6,0,0.0001);
	this.echoWet.gain.setTargetAtTime(0.4,0,0.0001);
	...
	this.convolverInput.connect(this.echoDry);
	this.echoDry.connect(this.output);

	this.convolverInput.connect(this.echoWet);
	...
	this.audioContext.decodeAudioData(this.irrArrayBuffer, function (audioBuffer) {
		...
		me.echoWet.connect(me.convolver);
